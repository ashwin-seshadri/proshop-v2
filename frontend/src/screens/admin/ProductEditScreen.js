            ...
            { isLoading ? <Loader/> : error ? <Message variant='danger'>{error.data.message}</Message> : (
                <Form onSubmit={ submitHandler }>
                    ...
                    <FormGroup controlId='price' className='my-2'>
                        ...
                        <FormControl type='number' placeholder='Enter price' value={price} onChange={(e) => setPrice(Number(e.target.value))}></FormControl>
                    </FormGroup>
                    <FormGroup controlId='image' className='my-2'>
                        ...
                        <FormControl type='file' label='choose image' onChange={uploadFileHandler}></FormControl>
                    ...
                    <FormGroup controlId='countInStock' className='my-2'>
                        ...
                        <FormControl type='number' placeholder='Enter Count In Stock' value={countInStock} onChange={(e) => setCountInStock(Number(e.target.value))}></FormControl>
                    </FormGroup>
